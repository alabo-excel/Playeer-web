            ...
            <div>
              <div className="lg:w-[40%]">
                ...
                <p className="text-sm text-[#6C6C6C] my-3">
                  This helps scouts and agents understand your football
          ...
          {step === 2 && (
            <div>
              ...
              <div className="grid lg:grid-cols-2 gap-6">
                ...
                <div>
                  <label className="font-semibold mb-2 text-sm">Previous Clubs</label>
                  <input
          ...
          {step === 3 && (
            <div>
              <div className="lg:w-[35%]">
                ...
                <p className="text-sm text-[#6C6C6C] my-3">
                  You can begin with the Free plan or unlock full features with
                  a Pro account.
                </p>
              </div>
              <PricingComp />
