    ...
    <>
      ...
      <section className='px-6 max-w-7xl mx-auto'>
        <div className='flex gap-4 justify-between my-10'>
          <div className='my-auto w-[45%]'>
            <div className='bg-[#E5F4FF] w-52 text-center rounded-full p-3 mb-4'>
              <p className='!text-[#0095FF] font-semibold'>ABOUT PLAYEER</p>
            </div>
            <h2 className='text-4xl font-bold'>Your Gateway to Global Football Opportunities</h2>
            ...
            <h2 className='text-3xl font-bold'>Key Benefits for Players:</h2>
            <ul className='my-3 ml-5 text-[#6C6C6C]'>
          ...
          <img src="/images/about-img.png" className='w-1/2' alt="" />
        </div>
        <div className='flex gap-4 my-32 justify-between'>
          <img src="/images/playeer.png" className='w-1/2' alt="" />
          <div className='my-auto w-[45%]' >
            <div className='bg-[#E5F4FF] w-52 text-center rounded-full p-3 mb-4'>
              <p className='!text-[#0095FF] font-semibold'>FIND A PLAYER</p>
            </div>
            <h2 className='text-4xl font-bold'>Discover Talent Easily</h2>
            ...
            <h2 className='text-3xl font-bold'>Explore by:</h2>
            <ul className='my-3 ml-5 text-[#6C6C6C]'>
              <li>Age Group</li>
        ...
        <div>
          <div className='bg-[#E5F4FF] w-80 text-center rounded-full p-3 mb-4'>
            <p className='!text-[#0095FF] font-semibold'>WHY CHOOSE PLAYEER?</p>
          </div>
          <div className='bg-[#F6F6F6] rounded-3xl p-10 flex justify-between'>
            <div className='w-[35%]'>
              <h2 className='text-xl font-bold'>What Makes Us the Smart Choice for Talent Discovery</h2>
      ...
      <section className='my-20'>
        <div className='w-[30%] !text-center mx-auto'>
          ...
          <h2 className='text-3xl font-bold'>Rising Stars You <br /> Shouldn’t Miss</h2>
      ...
      <section className='bg-[#F4F4F4] rounded-3xl max-w-7xl mx-auto p-6'>
        <div className='w-[30%] !text-center mx-auto'>
          <div className='bg-[#E5F4FF] w-52 mx-auto text-center rounded-full p-3 mb-4'>
            <p className='!text-[#0095FF] font-semibold'>HOW IT WORKS</p>
          </div>
          <h2 className='text-3xl font-bold'>Your Roadmap to Football Success</h2>
        </div>
      ...
      <section className='my-20'>
        <div className='w-[40%] !text-center mx-auto'>
          ...
          <h2 className='text-3xl font-bold'>What players, scouts & Agent have to say about us</h2>
        </div>
      </section>

      <section className='cta my-32 h-[80vh] flex items-center justify-center'>
        <div className='w-[40%] !text-center mx-auto'>
          ...
          <h2 className='text-4xl font-bold'>Browse Videos, Matches, and Drills in One Place</h2>
