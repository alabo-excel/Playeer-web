...
const PricingComp = () => {
  return (
    ...
    <div className="grid md:grid-cols-3 gap-8">
      <div className="bg-[#E5F4FF] rounded-2xl p-8 my-auto">
        ...
        <button className='rounded-full w-full p-4 text-white bg-[#0095FF]'>Get Started Free</button>
      ...
      <div className="bg-[#000B42] rounded-2xl p-8 relative">
        ...
        <button className='rounded-full w-full p-4 text-white bg-[#0095FF]'>Go Yearly Pro (Save 17%)</button>
        ...
        <div className='text-center'>
          <button className='text-[#17E85E] p-4 rounded-full w-52 bg-[#0F993E4D] '>Recommended</button>
        </div>
      </div>
      ...
      <div className="bg-[#E5F4FF] rounded-2xl p-8 my-auto">
        ...
        <button className='rounded-full w-full p-4 text-white bg-[#0095FF]'>Go Monthly Pro</button>
